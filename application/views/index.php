      ...
      <div class="container">
        ...
        <div class="navbar-custom-menu">
          <ul class="nav navbar-nav">
            ...
            <li><a href="<?php echo base_url(); ?>index.php/Register">Registrarse</a></li>
            <!-- /. bodeguitadeoro -->
          </ul>
        </div>
      </div>
  ...
  <div class="content-wrapper">
    <div class="container">
      ...
      <section class="content">
        <!-- bodeguitadeoro -->
        <div class="box-body">
          <img class="img-responsive pad" src="<?php echo base_url()?>assets/template/dist/img/bodeguitadeoro_uno.jpeg" alt="Photo">
          <img class="img-responsive pad" src="<?php echo base_url()?>assets/template/dist/img/bodeguitadeoro_dos.jpeg" alt="Photo">
        </div>
        <!-- /. bodeguitadeoro -->
      </section>
      <!-- /.content -->
